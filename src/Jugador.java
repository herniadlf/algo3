...
public class Jugador {
	...
	public void atacarCon(Unidad agresor, Atacable victima) throws ExcepcionLaUnidadNoPertenceATuTropa, ExcepcionPosicionInvalida, ExcepcionElementoFueraDelRangoDeAtaque, ExcepcionFinDeTurnoPorMaximoDeAtaques {			
		verificarUnidad(agresor);
